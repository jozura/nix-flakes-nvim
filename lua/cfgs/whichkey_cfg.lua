...
function M.setup()
    ...
    { "<leader>rtt","<cmd>ConjureEvalRootForm<cr><cmd>ConjureCljRunCurrentTest<cr>", desc = "Run test"},
    { "<leader>rtn","<cmd>ConjureEvalBuf<cr><cmd>ConjureCljRunCurrentNsTests<cr>", desc = "Run ns tests"},
