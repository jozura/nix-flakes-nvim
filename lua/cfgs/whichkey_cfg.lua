...
function M.setup()
    ...
    { "<leader>rt","<cmd>ConjureEvalRootForm<cr><cmd>ConjureCljRunCurrentTest<cr>", desc = "Run test"},
    { "<leader>rn","<cmd>ConjureEvalBuf<cr><cmd>ConjureCljRunCurrentNsTests<cr>", desc = "Run ns tests"},
    ...
    { "<leader>tv", "<cmd>Telescope help_tags<cr>", desc = "Search In Vim Help Files" },
  })
end
